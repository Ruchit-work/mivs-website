...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* ===== Background Layers (no solid white so gradients show) ===== */}
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 80% 70% at 50% 0%, rgba(253, 186, 116, 0.6) 0%, rgba(253, 186, 116, 0.25) 40%, transparent 70%)",
          }}
        />

        {/* Indigo / purple mid glow – soft lavender */}
        <div
          className="absolute top-40 left-1/2 -translate-x-1/2 w-[1200px] h-[700px] blur-3xl"
          style={{
            background: "radial-gradient(ellipse 70% 65% at 50% 45%, rgba(199, 210, 254, 0.65) 0%, rgba(199, 210, 254, 0.3) 45%, transparent 70%)",
          }}
        />

        {/* White / light center glow – keeps center airy */}
        <div
          className="absolute top-24 left-1/2 -translate-x-1/2 w-[800px] h-[500px] blur-2xl"
          style={{
            background: "radial-gradient(ellipse 60% 50% at 50% 35%, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.4) 50%, transparent 70%)",
          }}
        />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center px-6">
        ...
        <p className="mt-6 text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
          ...
          streamline operations, and scale enterprise workflows with
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <Link
            ...
            className="px-8 py-4 rounded-2xl 
              ...
              hover:scale-[1.02] transition-all duration-300 inline-flex items-center justify-center"
          >
          ...
          <Link
            ...
            className="px-8 py-4 rounded-2xl 
              ...
              hover:bg-slate-50 transition-all duration-300 inline-flex items-center justify-center"
          >
            Explore Solutions
          </Link>
